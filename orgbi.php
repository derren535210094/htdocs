...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #0d8490;">Pengajar</div>
        <div id="garispengajarmat" style="color: #0d8490;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1zjMji9dxCjmyU0bc8nPkHS3Zb6Rhth-w" alt="Najwa Shihab, S.H., LL.M." data-atf="false" loading="lazy">
        <div id="namajerome">Najwa Shihab</div>
        <div id="temansekelasmat" style="color: #0d8490;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #0d8490;">5 siswa</div>
        <div id="garistemsekmat" style="color: #0d8490;"></div>
