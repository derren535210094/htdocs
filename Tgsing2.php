...
<html>
    <head>
        <title> WHAT IS NARRATIVE TEXT?</title>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat" style="color: #3e4ca2;">WHAT IS NARRATIVE TEXT?</div>
            <div id="namaorgmat">Maudy Ayunda <span style="font-size: 20px; position: relative;">&bull;</span> 28 Nov 2022</div>
            <div id="garisnamaorgmat" style="color: #3e4ca2;"></div>
            <div id="soalmat">Dear all, try to explain what you know about narrative text?
                <br>
                <div style="line-height: 2;">
                (Upload file in Word/PDF !)
                </div>
            </div>
