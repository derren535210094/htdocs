...
<html>
    <head>
        <title>APA ITU ARSITEKTUR KOMPUTER?</title>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat" style="color: #566e79;">APA ITU ARSITEKTUR KOMPUTER?</div>
            <div id="namaorgmat">Nadiem Makarim <span style="font-size: 20px; position: relative;">&bull;</span> 30 Nov 2022</div>
            <div id="garisnamaorgmat" style="color: #566e79;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang anda ketahui tentang arsitektur komputer?
                <br>
