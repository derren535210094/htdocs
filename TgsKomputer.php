...
<html>
    <head>
        <title> APA ITU KODE BINER?</title>
        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Komputer.php">
            <div id="matnama"> <span>KOMPUTER</span>  </a> </div>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Komputer.php">
            <div id="matkelas"> <span> KOMPUTER SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="gambukmat2" style="background-color: #566e79;"></div>
            ...
            <div id="titletgsmat" style="color: #566e79;">APA ITU KODE BINER?</div>
            <div id="namaorgmat">Nadiem Makarim <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #566e79;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang anda ketahui tentang kode biner?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabankomputer" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabankomputer").value
   );
   li.appendChild(text);
