...
<head>
    <title>MATEMATIKA SMA KELAS X-XII</title>
...
<body>
    ...
    <div id="atas">
        ...
        <div id="navbar2" class="btn-group dropright">
            ...
            <div id="navbar3" class="dropdown-menu">
              ...
              <br><br>
              <a class="dropdown-item" href="Mat.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1LXdzz5BxRs7EQOOaX5WJ1Go_Mf1lD9Ql" alt="Jerome Polin Sijabat, S.T." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> MATEMATIKA</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Inggris.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1GxhzbvFJlcFCDiRi34LV_oowYLgmXdT3" alt="Ayunda Faza Maudya, B.A., M.A., M.B.A." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> BAHASA INGGRIS</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Komputer.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1vCZmZZ9P1OI3Gv7E7xQfwKHi8XrBLRdI" alt="Nadiem Anwar Makarim, B.A., M.B.A." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> KOMPUTER</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Ekonomi.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1kxiVxcJ3cwG2b5zOPsTZHbpNELgZj4PM" alt="Shafa Tasya Kamila, S.E., MPA." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> EKONOMI</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Pkwu.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=159PBYdLlPPPvfJ9GftC3QDrB-kokMNQW" alt="Dr. H. Sandiaga Salahuddin Uno, BBA., MBA." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> PENDIDIKAN KEWIRAUSAHAAN</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Bi.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1zjMji9dxCjmyU0bc8nPkHS3Zb6Rhth-w" alt="Najwa Shihab, S.H., LL.M." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> BAHASA INDONESIA</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Pkn.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1EPJpevPB_o2DQbT0aYFVXzkA1SISI1HW" alt="Dr. Hotman Paris Hutapea, S.H., LL.M., M.Hum." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> PENDIDIKAN KEWARGANEGARAAN</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>
            
            <a class="dropdown-item" href="Or.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1scAT2DxSEZirioX4KsTf_9GYEx_8lgEC" alt="Deodatus Andreas Deddy Cahyadi Sunjoyo, S.Psi., M.Psi." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> PENDIDIKAN JASMANI DAN ROHANI</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>

            <a class="dropdown-item" href="Senbud.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1F8j5plJx_U2FPgr87VAT0fTvBUJzMvGD" alt="Diandra Paramitha Sastrowardoyo, S.Fil., M.M." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> SENI BUDAYA</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>

            <a class="dropdown-item" href="Fisika.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1TnzWP6CNuTeI_hbuFhcccEpX6DvGxgd0" alt="Rizki Syarif, S.Si., M.Fis., PhD." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> FISIKA</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>

            <a class="dropdown-item" href="Sejarah.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1UP498hopt8HsipsshoymXd976tVCngs6" alt="JJ Rizal, S.S." data-atf="false">
                <div id="perataan3" style="color: #494d50;"> SEJARAH</div>
            <div id="perataan4" style="color: #494d50;">SMA KELAS X-XII</div></a>

            <a class="dropdown-item" href="Musik.html">
                <img id="photopro" aria-hidden="true" src="https://drive.google.com/uc?id=1rZgJxQLWahhZOM5gbzUr4dLSyNsF9LdS" alt="Rizki Rahmahadian Pamungkas, S.Ds." data-atf="false">
        ...
        <div id="matnama"> <span>MATEMATIKA</span> </div>

        <a style="text-decoration: none;" target="_self" href="Mat.php">
        <div id="streammat">
            <div id="kotstreamm">
    ...
    <a style="text-decoration: none;" target="_self" href="orgmat.php">
            <div id="kotmat">
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="matkelas"> <span> MATEMATIKA SMA KELAS X-XII</span> </div>
            <div id="garismat"></div>
            
        </div>

        <div id="namapengajarmat" style="color: #d91a60;">Pengajar</div>
        <div id="garispengajarmat" style="color: #d91a60;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1LXdzz5BxRs7EQOOaX5WJ1Go_Mf1lD9Ql" alt="Jerome Polin Sijabat, S.T." data-atf="false" loading="lazy">
        <div id="namajerome">Jerome Polin</div>
        <div id="temansekelasmat" style="color: #d91a60;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #d91a60;">5 siswa</div>
        <div id="garistemsekmat" style="color: #d91a60;"></div>
