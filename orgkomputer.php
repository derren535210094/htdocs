...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #566e79;">Pengajar</div>
        <div id="garispengajarmat" style="color: #566e79;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1vCZmZZ9P1OI3Gv7E7xQfwKHi8XrBLRdI" alt="Nadiem Anwar Makarim, B.A., M.B.A." data-atf="false" loading="lazy">
        <div id="namajerome">Nadiem Makarim</div>
        <div id="temansekelasmat" style="color: #566e79;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #566e79;">5 siswa</div>
        <div id="garistemsekmat" style="color: #566e79;"></div>
