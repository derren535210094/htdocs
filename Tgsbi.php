        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Bi.php">
            <div id="matnama"> <span>BAHASA INDONESIA</span>  </a> </div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Bi.php">
            <div id="matkelas"> <span> BAHASA INDONESIA SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="gambukmat2" style="background-color:#0d8490;"></div>
            ...
            <div id="titletgsmat" style="color: #0d8490;">DEBAT</div>
            <div id="namaorgmat">Najwa Shihab <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #0d8490;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan tata cara debat yang baik?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanbi" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanbi").value
   );
   li.appendChild(text);
