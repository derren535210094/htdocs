...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <div id="walmat">
                <div id="namamat"> <div id="namamat1">MATEMATIKA</div></div>
                <div id="namamatkelas"> <div id="namamatkelas">SMA KELAS X-XII</div></div>
                
            </div>

            <a style="text-decoration: none;" target="_self" href="Tgsmat.php">
            <div id="kottugmat" target="_self" href="Tgsmat.php">

<div id="namatgsmat" style="color: black;">Jerome Polin memposting materi baru: APA ITU ALJABAR?</div>

<div id="tglpostmat" style="color: #6e7176;">10 Okt 2022</div>

<div id="gambukmat" style="background-color: #d91a60;"></div>
...
<br><br><br><br>
 ...
 <a style="text-decoration: none;" target="_self" href="Tgsmat2.php">
            <div id="kottugmat" target="_self" href="Tgsmat2.php">

<div id="namatgsmat" style="color: black;">Jerome Polin memposting materi baru: APA ITU TRIGONOMETRI?</div>

<div id="tglpostmat" style="color: #6e7176;">27 Nov 2022</div>
