...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <div id="titletgsmat" style="color: #0d8490;">TEKS EKSPOSISI</div>
            <div id="namaorgmat">Najwa Shihab <span style="font-size: 20px; position: relative;">&bull;</span> 30 Nov 2022</div>
            <div id="garisnamaorgmat" style="color: #0d8490;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian sebutkan dan jelaskan 3 struktur teks eksposisi !
                <br>
