...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat"  style="color: #faa824;">PETA</div>
            <div id="namaorgmat">JJ Rizal <span style="font-size: 20px; position: relative;">&bull;</span> 1 Des 2022</div>
            <div id="garisnamaorgmat" style="color: #faa824;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan tujuan dibentuknya organisasi PETA?
                <br>
