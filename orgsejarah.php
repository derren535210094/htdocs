...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #faa824;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #faa824;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1UP498hopt8HsipsshoymXd976tVCngs6" alt="JJ Rizal, S.S." data-atf="false" loading="lazy">
        <div id="namajerome">JJ Rizal</div>
        <div id="temansekelasmat" style="color: #faa824;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #faa824;">5 siswa</div>
        <div id="garistemsekmat" style="color: #faa824;"></div>
