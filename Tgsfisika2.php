...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat"  style="color: #4167b2;">HAMBATAN</div>
            <div id="namaorgmat">Rizki Syarif <span style="font-size: 20px; position: relative;">&bull;</span> 1 Des 2022</div>
            <div id="garisnamaorgmat" style="color: #4167b2;"></div>
            <div id="soalmat"> Sebuah solder memiliki beda potensial 10 V dan kuat arus listrik 2A. Maka hambatan solder tersebut adalah?
                <br>
