...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #30ad71;">Pengajar</div>
        <div id="garispengajarmat" style="color: #30ad71;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1kxiVxcJ3cwG2b5zOPsTZHbpNELgZj4PM" alt="Shafa Tasya Kamila, S.E., MPA." data-atf="false" loading="lazy">
        <div id="namajerome">Tasya Kamila</div>
        <div id="temansekelasmat" style="color: #30ad71;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #30ad71;">5 siswa</div>
        <div id="garistemsekmat" style="color: #30ad71;"></div>
