...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #673bb8;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #673bb8;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1rZgJxQLWahhZOM5gbzUr4dLSyNsF9LdS" alt="Rizki Rahmahadian Pamungkas, S.Ds." data-atf="false" loading="lazy">
        <div id="namajerome">Pamungkas</div>
        <div id="temansekelasmat" style="color: #673bb8;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #673bb8;">5 siswa</div>
        <div id="garistemsekmat" style="color: #673bb8;"></div>
