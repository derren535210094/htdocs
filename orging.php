...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #3e4ca2;">Pengajar</div>
        <div id="garispengajarmat" style="color: #3e4ca2;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1GxhzbvFJlcFCDiRi34LV_oowYLgmXdT3" alt="Ayunda Faza Maudya, B.A., M.A., M.B.A." data-atf="false" loading="lazy">
        <div id="namajerome">Maudy Ayunda</div>
        <div id="temansekelasmat" style="color: #3e4ca2;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #3e4ca2;">5 siswa</div>
        <div id="garistemsekmat" style="color: #3e4ca2;"></div>
