...
<html>
    <head>
        <title> SENI RUPA 2D DAN 3D</title>
        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Senbud.php">
            <div id="matnama"> <span>SENI BUDAYA</span>  </a> </div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Senbud.php">
            <div id="matkelas"> <span> SENI BUDAYA SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="gambukmat2" style="background-color: #90a4ad;"></div>
            ...
            <div id="titletgsmat"  style="color: #90a4ad;">SENI RUPA 2D DAN 3D</div>
            <div id="namaorgmat">Dian Sastrowardoyo <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #90a4ad;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa perbedaan karya seni rupa 2D dengan 3D?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabansenbud" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabansenbud").value
   );
   li.appendChild(text);
