...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat"  style="color: #90a4ad;">SENI RUPA</div>
            <div id="namaorgmat">Dian Sastrowardoyo <span style="font-size: 20px; position: relative;">&bull;</span> 1 Des 2022</div>
            <div id="garisnamaorgmat" style="color: #90a4ad;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan penyelenggaraan pameran seni rupa di sekolah !
                <br>
