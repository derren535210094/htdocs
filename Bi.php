...
<html>
    ...
    <head>
        <title>BAHASA INDONESIA SMA KELAS X-XII</title>
...
setTimeout(function () {
    ...
    <body>
        ...
        <div id="atas">
            ...
            <div id="matnama"> <span>BAHASA INDONESIA</span> </div>

            <a style="text-decoration: none;" target="_self" href="Bi.php">
            <div id="streammat">
                <div id="kotstreamm">
        ...
        <a style="text-decoration: none;" target="_self" href="orgbi.php">
                <div id="kotmat">
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <div id="matkelas"> <span> BAHASA INDONESIA SMA KELAS X-XII</span> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="walbi">
                <div id="namamat"> <div id="namamat1">BAHASA INDONESIA</div></div>
                <div id="namamatkelas"> <div id="namamatkelas">SMA KELAS X-XII</div></div>
                
            </div>

            <a style="text-decoration: none;" target="_self" href="Tgsbi.php">
            <div id="kottugmat" target="_self" href="Tgsbi.php">

<div id="namatgsmat" style="color: black;">Najwa Shihab memposting materi baru: DEBAT</div>

<div id="tglpostmat" style="color: #6e7176;">10 Okt 2022</div>

<div id="gambukbi" style="background-color: #0d8490;"></div>      
...
<svg id="logbukmat" focusable="false" width="24" height="24" viewBox="0 0 24 24"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H6V4h2v8l2.5-1.5L13 12V4h5v16z"></path></svg>
 ...
 <a style="text-decoration: none;" target="_self" href="Tgsbi2.php">
            <div id="kottugmat" target="_self" href="Tgsbi2.php">

<div id="namatgsmat" style="color: black;">Najwa Shihab memposting materi baru: TEKS EKSPOSISI</div>

<div id="tglpostmat" style="color: #6e7176;">30 Nov 2022</div>

<div id="gambukmat" style="background-color: #0d8490;"></div>
