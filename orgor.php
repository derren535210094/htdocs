...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #646464;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #646464;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1scAT2DxSEZirioX4KsTf_9GYEx_8lgEC" alt="Deodatus Andreas Deddy Cahyadi Sunjoyo, S.Psi., M.Psi." data-atf="false" loading="lazy">
        <div id="namajerome">Deddy Corbuzier</div>
        <div id="temansekelasmat" style="color: #646464;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #646464;">5 siswa</div>
        <div id="garistemsekmat" style="color: #646464;"></div>
