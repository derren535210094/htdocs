        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Fisika.php">
            <div id="matnama"> <span>FISIKA</span>  </a> </div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Fisika.php">
            <div id="matkelas"> <span> FISIKA SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="gambukmat2" style="background-color: #4167b2;"></div>
            ...
            <div id="titletgsmat"  style="color: #4167b2;">RELATIVITAS</div>
            <div id="namaorgmat">Rizki Syarif <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #4167b2;"></div>
            <div id="soalmat"> Halo anak-anak, coba kalian jelaskan apa yang dimaksud dengan relativitas, serta jelaskan rumus relativitas terkenal<br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanfisika" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanfisika").value
   );
   li.appendChild(text);
