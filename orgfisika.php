...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #4167b2;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #4167b2;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1TnzWP6CNuTeI_hbuFhcccEpX6DvGxgd0" alt="Rizki Syarif, S.Si., M.Fis., PhD." data-atf="false" loading="lazy">
        <div id="namajerome">Rizki Syarif</div>
        <div id="temansekelasmat" style="color: #4167b2;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #4167b2;">5 siswa</div>
        <div id="garistemsekmat" style="color: #4167b2;"></div>
