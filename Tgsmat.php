        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Mat.php">
            <div id="matnama"> <span>MATEMATIKA</span>  </a> </div>
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Mat.php">
            <div id="matkelas"> <span> MATEMATIKA SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="gambukmat2" style="background-color: #d91a60;"></div>
            ...
            <div id="titletgsmat" style="color: #d91a60;">APA ITU ALJABAR?</div>
            <div id="namaorgmat">Jerome Polin <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #d91a60;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang anda ketahui tentang aljabar?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanmat" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanmat").value
   );
   li.appendChild(text);
