...
<html>
    <head>
        <title> WHAT IS DESCRIPTIVE TEXT?</title>
...
setTimeout(function () {
    ...
    <body>
        ...
        <div id="atas">
         ...
         <a style="text-decoration: none;  color: #404447;" target="_self" href="Inggris.php">
            <div id="matnama"> <span>INGGRIS</span> </a> </div>
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Inggris.php">
            <div id="matkelas"> <span> INGGRIS SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="gambukmat2" style="background-color: #3e4ca2;"></div>
            ...
            <div id="titletgsmat" style="color: #3e4ca2;">WHAT IS DESCRIPTIVE TEXT?</div>
            <div id="namaorgmat">Maudy Ayunda <span style="font-size: 20px; position: relative;">&bull;</span> 10 Oct 2022</div>
            <div id="garisnamaorgmat" style="color: #3e4ca2;"></div>
            <div id="soalmat">Dear all, try to explain what you know about descriptive text?
                <br>
            ...
            <div id="komensiswamat">Class comments</div>

            <div id="gariskotjawmat"></div>
            <div id="kotjawmat"></div>
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabaninggris" name="jawabanmat" class="jawabanmat" required>
                <span class="floating-label-mat">Add class comments....</span>
            </div>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabaninggris").value
   );
   li.appendChild(text);
