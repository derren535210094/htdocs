...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #029687;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #029687;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1EPJpevPB_o2DQbT0aYFVXzkA1SISI1HW" alt="Dr. Hotman Paris Hutapea, S.H., LL.M., M.Hum." data-atf="false" loading="lazy">
        <div id="namajerome">Hotman Paris</div>
        <div id="temansekelasmat" style="color: #029687;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #029687;">5 siswa</div>
        <div id="garistemsekmat" style="color: #029687;"></div>
