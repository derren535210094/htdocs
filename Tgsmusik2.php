        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Musik.php">
            <div id="matnama"> <span>MUSIK</span>  </a> </div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Musik.php">
            <div id="matkelas"> <span> MUSIK SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="gambukmat2" style="background-color: #673bb8;"></div>
            ...
            <div id="titletgsmat"  style="color: #673bb8;">MAKNA LAGU</div>
            <div id="namaorgmat">Pamungkas <span style="font-size: 20px; position: relative;">&bull;</span> 1 Des 2022</div>
            <div id="garisnamaorgmat" style="color: #673bb8;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian tonton video berikut. Lalu jelaskan makna lirik dalam video lagu tersebut !
                <br>
                <div style="line-height: 2;">
                (Upload file dalam Word/PDF !)
                </div>
            </div>
            <div id="garisnamaorgmat2"></div><br><br>
            ...
            <div id="vidalan">
            <iframe width="608" height="298" src="https://www.youtube.com/embed/g4hGRvs6HHU" title="Alan Walker ft. Gavin James - Tired" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
