...
<html>
    ...
    <head>
        <title>EKONOMI SMA KELAS X-XII</title>
...
setTimeout(function () {
    ...
    <body>
        ...
        <div id="atas">
            ...
            <div id="matnama"> <span>EKONOMI</span> </div>

            <a style="text-decoration: none;" target="_self" href="Ekonomi.php">
            <div id="streammat">
                <div id="kotstreamm">
        ...
        <a style="text-decoration: none;" target="_self" href="orgekon.php">
                <div id="kotmat">
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <div id="matkelas"> <span> EKONOMI SMA KELAS X-XII</span> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="walekon">
                <div id="namamat"> <div id="namamat1">EKONOMI</div></div>
                <div id="namamatkelas"> <div id="namamatkelas">SMA KELAS X-XII</div></div>
                
            </div>

            <a style="text-decoration: none;" target="_self" href="Tgsekon.php">
            <div id="kottugmat" target="_self" href="Tgsekon.php">

<div id="namatgsmat" style="color: black;">Tasya Kamila memposting materi baru: APA ITU PASAR OLIGOPOLI?</div>

<div id="tglpostmat" style="color: #6e7176;">10 Okt 2022</div>

<div id="gambukmat" style="background-color: #30ad71;"></div>      
...
<svg id="logbukmat" focusable="false" width="24" height="24" viewBox="0 0 24 24"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H6V4h2v8l2.5-1.5L13 12V4h5v16z"></path></svg>
 ...
 <a style="text-decoration: none;" target="_self" href="Tgsekon2.php">
            <div id="kottugmat" target="_self" href="Tgsekon2.php">

<div id="namatgsmat" style="color: black;">Tasya Kamila memposting materi baru: SEBUTKAN MACAM-MACAM KEGIATAN EKONOMI?</div>
