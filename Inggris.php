...
<html>
    ...
    <head>
        <title>INGGRIS SMA KELAS X-XII</title>
...
setTimeout(function () {
    ...
    <body>
        ...
        <div id="atas">
            ...
            <div id="matnama"> <span>INGGRIS</span> </div>

            <a style="text-decoration: none;" target="_self" href="Inggris.php">
            <div id="streammat">
                <div id="kotstreamm">
        ...
        <a style="text-decoration: none;" target="_self" href="orging.php">
                <div id="kotmat">
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <div id="matkelas"> <span> INGGRIS SMA KELAS X-XII</span> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="waling">
                <div id="namamat"> <div id="namamat1">INGGRIS</div></div>
                <div id="namamatkelas"> <div id="namamatkelas">SMA KELAS X-XII</div></div>
                
            </div>

            <a style="text-decoration: none;" target="_self" href="Tgsing.php">
            <div id="kottugmat" target="_self" href="Tgsing.php">

<div id="namatgsmat" style="color: black;">Maudy Ayunda memposting materi baru: WHAT IS DESCRIPTIVE TEXT?</div>

<div id="tglpostmat" style="color: #6e7176;">10 Okt 2022</div>

<div id="gambukmat" style="background-color: #3e4ca2;"></div>      
...
<svg id="logbukmat" focusable="false" width="24" height="24" viewBox="0 0 24 24"><path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H6V4h2v8l2.5-1.5L13 12V4h5v16z"></path></svg>
 ...
 <a style="text-decoration: none;" target="_self" href="Tgsing2.php">
            <div id="kottugmat" target="_self" href="Tgsing2.php">

<div id="namatgsmat" style="color: black;">Maudy Ayunda memposting materi baru: WHAT IS NARRATIVE TEXT?</div>

<div id="tglpostmat" style="color: #6e7176;">28 Nov 2022</div>
