...
<html>
    <head>
        <title> APA PERBEDAAN INTERIOR DAN EKSTERIOR?</title>
        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Pkwu.php">
            <div id="matnama"> <span>PENDIDIKAN KEWIRAUSAHAAN</span>  </a> </div>
...
<?= htmlspecialchars($user["name"]) ?> </button></a>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Pkwu.php">
            <div id="matkelas"> <span> PENDIDIKAN KEWIRAUSAHAAN SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="gambukmat2" style="background-color: #fe8b66;"></div>
            ...
            <div id="titletgsmat" style="color: #fe8b66;">APA PERBEDAAN INTERIOR DAN EKSTERIOR?</div>
            <div id="namaorgmat">Sandiaga Uno <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #fe8b66;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang membedakan antara interior dan eksterior?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanpkwu" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanpkwu").value
   );
   li.appendChild(text);
