...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat"  style="color: #673bb8;">MUSIK KONTEMPORER</div>
            <div id="namaorgmat">Pamungkas <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #673bb8;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa perbedaan musik kontemporer dengan musik modern?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanmusik" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanmusik").value
   );
   li.appendChild(text);
