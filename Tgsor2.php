...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <div id="titletgsmat"  style="color: #646464;">PIVOT</div>
            <div id="namaorgmat">Deddy Corbuzier <span style="font-size: 20px; position: relative;">&bull;</span> 1 Des 2022</div>
            <div id="garisnamaorgmat" style="color: #646464;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang dimaksud dengan pivot dalam permainan bola basket !
                <br>
