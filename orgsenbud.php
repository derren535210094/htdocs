...
<?= htmlspecialchars($user["name"]) ?> </button></a>
        ...
        <div id="namapengajarmat" style="color: #90a4ad;">Pengajar</div>
        <div id="garispengajarmat"  style="color: #90a4ad;"></div>

        <img id="photo1pengajar" aria-hidden="true" src="https://drive.google.com/uc?id=1F8j5plJx_U2FPgr87VAT0fTvBUJzMvGD" alt="Diandra Paramitha Sastrowardoyo, S.Fil., M.M." data-atf="false" loading="lazy">
        <div id="namajerome">Dian Sastrowardoyo</div>
        <div id="temansekelasmat" style="color: #90a4ad;">Teman Sekelas</div>
        <div id="jumlahsiswamat" style="color: #90a4ad;">5 siswa</div>
        <div id="garistemsekmat" style="color: #90a4ad;"></div>
