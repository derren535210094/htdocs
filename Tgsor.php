        ...
        <div id="atas">
         ...
         <div id="navbar2" class="btn-group dropright">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" focusable="false" id="navbar"><path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Or.php">
            <div id="matnama"> <span>PENDIDIKAN JASMANI DAN ROHANI</span>  </a> </div>
...
#gambukmat2{
  ...
  margin-left: 167px;
            ...
            <a style="text-decoration: none;  color: #404447;" target="_self" href="Or.php">
            <div id="matkelas"> <span> PENDIDIKAN JASMANI DAN ROHANI SMA KELAS X-XII</span> </a> </div>
                <div id="garismat"></div>
                
            </div>

            <div id="gambukmat2" style="background-color: #646464;"></div>
            ...
            <div id="titletgsmat"  style="color: #646464;">KEBUGARAN JASMANI</div>
            <div id="namaorgmat">Deddy Corbuzier <span style="font-size: 20px; position: relative;">&bull;</span> 10 Okt 2022</div>
            <div id="garisnamaorgmat" style="color: #646464;"></div>
            <div id="soalmat">Halo anak-anak, coba kalian jelaskan apa yang dimaksud dengan kebugaran jasmani?
                <br>
            ...
            <div>
                <input type="text" style="width:800px" maxlength="10000" id ="jawabanor" name="jawabanmat" class="jawabanmat" required>
   ...
   const text = document.createTextNode(
   	document.getElementById("jawabanor").value
   );
   li.appendChild(text);
